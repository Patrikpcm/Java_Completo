/**
 * - Sobrecarga
 * É um recurso que uma classe possui de oferecer mais de uma operação com o mesmo nome, porém
 * com diferentes listas de parâmetros
 */

package OO.sobrecarga.application;

import java.util.Locale;
import java.util.Scanner;

import OO.sobrecarga.entities.Product;
